...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all( /* FN */
    ...
    _______, _______, KC_PGUP, _______, _______, _______, _______, _______, KC_UP,   _______, _______, KC_VOLD, KC_VOLU,          _______,
    _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,                   _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_MPRV, KC_MNXT, _______,          _______, _______,
